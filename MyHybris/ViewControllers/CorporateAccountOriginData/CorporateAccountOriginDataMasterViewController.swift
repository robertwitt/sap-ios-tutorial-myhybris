...
class CorporateAccountOriginDataMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    var apimktcorporateaccountsrvEntities: APIMKTCORPORATEACCOUNTSRVEntities<OnlineODataProvider>!
    public var loadEntitiesBlock: ((_ completionHandler: @escaping ([CorporateAccountOriginData]?, Error?) -> Void) -> Void)?
    private var entities: [CorporateAccountOriginData] = [CorporateAccountOriginData]()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let corporateaccountorigindata = self.entities[indexPath.row]
        let cell = CellCreationHelper.objectCellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: "CorporateAccountOrigin, CorporateAccountID", value: "\(corporateaccountorigindata.corporateAccountOrigin!), \(corporateaccountorigindata.corporateAccountID!)")
        return cell
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! CorporateAccountOriginDataDetailViewController
...
extension CorporateAccountOriginDataMasterViewController: EntitySetUpdaterDelegate {
